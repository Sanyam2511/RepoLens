    ...
    <div className="min-h-screen bg-[#f7f5f0] text-slate-900">
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 18% 12%, rgba(254, 243, 199, 0.9), transparent 50%), radial-gradient(circle at 82% 12%, rgba(219, 234, 254, 0.75), transparent 46%), radial-gradient(circle at 20% 88%, rgba(224, 231, 255, 0.66), transparent 52%)",
          }}
        />
        <div className="absolute -top-28 -right-20 h-[280px] w-[280px] rounded-full bg-amber-100/70 blur-3xl" />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col px-4 py-5 sm:px-6 lg:px-8">
        ...
        <div className="grid flex-1 gap-5 lg:grid-cols-[1fr_minmax(360px,440px)]">
          <section className="rounded-3xl border border-slate-200/80 bg-white/85 p-6 shadow-[0_14px_30px_rgba(15,23,42,0.08)] backdrop-blur lg:p-8">
          ...
          <aside className="rounded-3xl border border-slate-200/80 bg-white/85 p-6 shadow-[0_14px_30px_rgba(15,23,42,0.08)] backdrop-blur lg:p-8">
