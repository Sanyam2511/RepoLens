...
export default function Footer() {
  return (
    <footer className="mx-auto w-[min(1200px,94vw)] mt-20 pb-16">
      <div className="rounded-[40px] border border-slate-200/70 bg-white/90 p-10 shadow-[0_26px_60px_rgba(15,23,42,0.14)]">
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="#analyze" className="rounded-full bg-slate-900 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-white shadow-sm hover:bg-slate-800">Start analysis</a>
              <a href="/history" className="rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-slate-700 hover:bg-slate-50">View history</a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 text-sm">
            <div>
              ...
              <ul className="mt-3 space-y-2 text-sm text-slate-600">
                ...
                <li><a href="/history" className="hover:text-slate-900">History</a></li>
